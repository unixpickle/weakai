...
const (
	...
	serializerTypeResidualLayer     = serializerTypePrefix + "ResidualLayer"
)
...
func init() {
	...
	serializer.RegisterTypedDeserializer(serializerTypeResidualLayer,
		DeserializeResidualLayer)
}
