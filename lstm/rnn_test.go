...
func rnnForTesting() *RNN {
	...
	net.memoryParams.InGateBiases = linalg.Vector{0.576392, 0.431650, 0.090567}
	net.memoryParams.OutGateBiases = linalg.Vector{0.52432, 0.25997, 0.59234}
	net.memoryParams.RemGateBiases = linalg.Vector{0.62371, 0.81187, 0.51603}
	net.memoryParams.InBiases = linalg.Vector{0.85035, 0.56379, 0.44774}
	return net
}
